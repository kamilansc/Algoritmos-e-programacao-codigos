...
def main():
    ...
    num1 = obter_numero_inteiro('Digite o primeiro valor possível para a variável "opção": ')
    num2 = obter_numero_inteiro('Digite o segundo valor possível para a variável "opção": ')
    num3 = obter_numero_inteiro('Digite o terceiro valor possível para a variável "opção": ')
